...
#let dvdtyp(
  ...
  set page(
    ...
    header: context {
      ...
      box(stroke: (bottom: 0.7pt), inset: 0.2em)[#text(font: "Noto Serif")[#author #h(1fr)#title]]
    },
  )
  ...
  align(center)[
    ...
    #v(0.3em, weak: true)
    #if author != none [#text(13pt)[#author]]\
    #text(12pt)[#datetime.today().display("[year].[month].[day]")]
  ]
